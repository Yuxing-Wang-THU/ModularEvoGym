...
from modularevogym.envs import BenchmarkBase
...
class WalkingFlat(BenchmarkBase):
    ...
    def __init__(self, body, connections=None, mode="normal", nca_setting=None, init_nca_design=None):
    ...
    def step(self, action):
        ...
        if self.mode == "modular":
            ...
            obs = np.concatenate((
                ...
                self.get_relative_pos_obs("robot").flatten(),
                ))
